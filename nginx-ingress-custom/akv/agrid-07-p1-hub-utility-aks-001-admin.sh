...
do
  ...
  kubectl apply -f ./alpha-eng-utilities/nginx-ingress-custom/akv/secretproviderclass-nginx-alpha-07-p1.yaml -n $ns
  ...
  then
    ...
    kubectl create secret -n $ns generic agrid-cpe-p1-akv-ro-obs-spn-01-secrets --from-literal clientid=1cd49c24-b1d3-4af1-b216-d816480f7a12 --from-literal clientsecret=$(az keyvault secret show --id https://agrid-07-p1-hub-kv-001.vault.azure.net/secrets/agrid-cpe-p1-akv-ro-obs-spn-01 -o tsv --query "value")
