...
do
  ...
  kubectl apply -f ./alpha-eng-utilities/nginx-ingress-custom/akv/secretproviderclass-nginx-alpha-06-e1.yaml -n $ns
  ...
  then
    ...
    kubectl create secret -n $ns generic agrid-cpe-e1-akv-ro-obs-spn-01-secrets --from-literal clientid=0d86580f-e839-4fd7-8397-f70d43b3a870 --from-literal clientsecret=$(az keyvault secret show --id https://agrid-06-e1-hub-kv-001.vault.azure.net/secrets/ac-eng-cpe-spn-devops-001 -o tsv --query "value")
